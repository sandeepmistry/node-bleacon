        ...
        characteristics: [
          new BlenoCharacteristic({
            ...
            onReadRequest: function(offset, callback) {
              ...
              callback(BlenoCharacteristic.RESULT_SUCCESS, Buffer.from('526164426561636f6e20555342000000000000000000000000000000000000000000000000', 'hex'));
            },
          ...
          new BlenoCharacteristic({
            ...
            onReadRequest: function(offset, callback) {
              ...
              callback(BlenoCharacteristic.RESULT_SUCCESS, Buffer.from('303235354433', 'hex'));
            }
          }),
          new BlenoCharacteristic({
            uuid: 'aaa2',
          ...
          new BlenoCharacteristic({
            ...
            onReadRequest: function(offset, callback) {
              ...
              callback(BlenoCharacteristic.RESULT_SUCCESS, Buffer.from('2f234454cf6d4a0fadf2f4911ba9ffa6', 'hex'));
            },
            onWriteRequest: function(data, offset, withoutResponse, callback) {
          ...
          new BlenoCharacteristic({
            ...
            onReadRequest: function(offset, callback) {
              ...
              callback(BlenoCharacteristic.RESULT_SUCCESS, Buffer.from('be', 'hex'));
            },
            onWriteRequest: function(data, offset, withoutResponse, callback) {
          ...
          new BlenoCharacteristic({
            ...
            onReadRequest: function(offset, callback) {
              ...
              callback(BlenoCharacteristic.RESULT_SUCCESS, Buffer.from('a000', 'hex'));
            },
            onWriteRequest: function(data, offset, withoutResponse, callback) {
          ...
          new BlenoCharacteristic({
            ...
            onReadRequest: function(offset, callback) {
              ...
              callback(BlenoCharacteristic.RESULT_SUCCESS, Buffer.from('00000000', 'hex'));
            },
            onWriteRequest: function(data, offset, withoutResponse, callback) {
